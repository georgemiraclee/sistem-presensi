$(function(){        
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Neutral", value: 2513},
            {label: "Positive", value: 764},
            {label: "Negative", value: 311}
        ],
    ...
    Morris.Bar({
        ...
        data: [
            ...
            { y: 'Today', a: 96, b: 41 , c: 88}
        ],
        xkey: 'y',
        ykeys: ['a', 'b','c'],
        labels: ['Positive', 'Negative','Neutral'],
        barColors: [ '#1caf9a', '#FEA223', '#33414E'],
        gridTextSize: '10px',
        hideHover: true,
        resize: true,
    ...
    Morris.Line({
      ...
      data: [
        { y: '2014-10-10', a: 2,b: 4,c:1},
        { y: '2014-10-11', a: 4,b: 6,c:8}
