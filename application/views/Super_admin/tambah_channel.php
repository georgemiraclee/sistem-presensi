                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tambah Channel</h3>                             
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="nama_channel"  id="nama_channel" class="form-control" pattern="^[a-z A-Z 0-9]*$" oninvalid="setCustomValidity('Gunakan karakter yang valid dan tidak boleh kosong')" oninput="this.setCustomValidity('')" required>
                                                </div>                                            
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <textarea class="form-control" rows="5" name="alamat_channel"  id="alamat_channel"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-user"></span></span>
                                                    <input type="email" name="email_channel"  id="email_channel" class="form-control" required>
                                                </div>                                            
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-user"></span></span>
                                                    <input type="text" name="telp_channel"  id="telp_channel" class="form-control" required>
                                                </div>                                            
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="input-group">
                                                    <span class="input-group-addon"><span class="fa fa-user"></span></span>
                                                    <input type="text" name="sms_channel"  id="sms_channel" class="form-control">
                                                </div>                                            
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <textarea class="form-control" rows="5" name="deskripsi_channel"  id="alamat_channel" required></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" class="form-control timepicker24" name="jam_masuk" required>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="input-group bootstrap-timepicker">
                                                    <input type="text" class="form-control timepicker24" name="jam_keluar" required>
                                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                                </div>
                                            </div>
                                        </div>
    ...
    var path = '<?php echo base_url();?>';
     $(document).ready(function() {
        $('#addForm').on('submit',(function(e) {
            ...
            $.ajax({
                method  : 'POST',
                url     : "<?php echo base_url('Data_channel/insertChannel'); ?>",
                data    : formData,
                contentType: false,
                processData: false,
