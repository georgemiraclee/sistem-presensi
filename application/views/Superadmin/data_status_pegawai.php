...
<div class="page-content-wrap">
    <div class="CONTAINER">
        <div class="col-md-12">
            <button class="btn btn-primary btn-lg" data-toggle='modal' data-target='#addUnit'><span class="fa fa-plus"></span> Tambah Status Pegawai</button>
                    ...
                    <table class="table datatable">
                        ...
                        ?>
                            <tr>
                                ...
                                <th width="500"><?php echo $value->nama_status_user ?></th>
                                <th width="250"><?php echo $value->is_aktif ?></th>
                                <th>
                                    <button class=" btn btn-primary"  data-toggle='modal' data-target='#modal_basic<?php echo $value->id_status_user ?> '>Ubah</button>
                                    <button type='button' class='btn btn-danger mb-control' data-box='#message-box-sound-2<?php echo $value->id_status_user ?>'>Hapus</button>
                                </th>
                            </tr>
                        <?php } ?>
                        <tbody></tbody>
            ...
            <div class='modal-body'>
                <form class="form-horizontal" id="add-form" action="javascript:void(0);">
                    <div class="form-group">
                        <label class="col-md-4 col-xs-12 control-label">Nama Status Pegawai</label>
                        <div class="col-md-6 col-xs-12">                                            
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <span class="fa fa-user"></span>
                                </span>
                                <input type="text" name="nama_status_user"  id="nama_status_user" class="form-control" oninvalid="setCustomValidity('Gunakan karakter yang valid dan tidak boleh kosong')" oninput="this.setCustomValidity('')" required>
                            </div>                                            
                        </div>
                    </div>
            </div>
...
<!-- danger with sound -->
<?php foreach ($data_status as $key => $value) { ?>
    <div class="message-box message-box-danger animated fadeIn"  data-sound="fail" id="message-box-sound-2<?php echo $value->id_status_user ?>">
            ...
            <div class="mb-middle">
                ...
                <div class="mb-footer">
                    <div class="float-right">
                        <a href="<?php echo base_url();?>Data_unit/delete/<?php echo $value->id_status_user ?>" class="btn btn-success btn-lg">Ya</a>
...
<!-- Modal Edit -->
<?php foreach ($data_status as $key => $value) { ?>
    <div class='modal' id='modal_basic<?php echo $value->id_status_user ?>' tabindex='-1' role='dialog' aria-labelledby='defModalHead' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-12">                                            
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_status_user"  id="nama_status_user" value="<?php echo $value->nama_status_user ?>" class="form-control" oninvalid="setCustomValidity('Gunakan karakter yang valid dan tidak boleh kosong')" oninput="this.setCustomValidity('')" required>
                                    <input type="hidden" name="id_status_user" value="<?php echo $value->id_status_user;?>">
                                </div>                                            
                            </div>
                        </div>
                </div>
...
<script>
    var urlInsert = "<?php echo base_url('StatusPegawai/insert'); ?>";
    var urlUpdate = "<?php echo base_url('StatusPegawai/update'); ?>";
