            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="<?php echo base_url();?>Leader/setting_akun" class="dropdown-item">My Profile</a>
                        <div class="dropdown-divider"></div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Leader/Dashboard" class="nav-link">
                        <i class="nav-icon fa fa-home"></i>
                        <p>Beranda</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Leader/Pegawai" class="nav-link">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>Leader/data_absensi" class="nav-link">
                                    <p>Data Absensi</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>Leader/cuti" class="nav-link">
                                    <p>Data Pengajuan</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo base_url();?>Leader/lembur" class="nav-link">
                                    <p>Lembur</p>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Leader/akses_absensi" class="nav-link">
                        <i class="nav-icon fas fa-map-marked-alt"></i>
                        <p>Akses Absensi Pegawai</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Leader/rangking" class="nav-link">
