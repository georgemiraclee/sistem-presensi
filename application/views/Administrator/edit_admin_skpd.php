                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    <label class="form-label"><i class="col-red">*</i> ID Alat</label>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="id_alat" value="<?php echo $data_staff->id_alat;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group form-float">
                                                ...
                                                <div class="form-group form-float">
                                                    <label class="form-label"><i class="col-red">*</i> Nama admin_skpd</label>
                                                    <div class="form-line">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="telp_user" value="<?php echo $data_staff->telp_user;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group form-float">
                                                    <label class="form-label">Email</label>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="email_user" value="<?php echo $data_staff->email_user;?>">
                                                    </div>
                                                </div>
                                                <div class="form-group form-float">
                                                    <label class="form-label">Alamat</label>
                                                    <div class="form-line">
                                                        <textarea rows="4" class="form-control no-resize" name="alamat_user"><?php echo $data_staff->alamat_user;?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group form-float">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick" id="skpd" name="skpd" required>
                                                            ...
                                                            <?php foreach ($skpd as $key => $value) { ?>
                                                                <option value="<?php echo $value->id_skpd;?>" <?php if ($value->id_skpd == $data_staff->id_skpd): echo 'selected' ?><?php endif ?>><?php echo $value->nama_skpd;?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            success: function(html){
                $('#struktur_organisasi').load(path+"Administrator/admin_skpd/get_level/"+e+"/"+f);
            }
        });
        ...
        $.ajax({
            success: function(html){
                $('#list_ttp').load(path+"Administrator/admin_skpd/list_ttpNew/"+x+"/"+y);
            }
        });
        $('#status_user').change(function() {
            ...
            $.ajax({
                success: function(html){
                    $('#list_ttp').load(path+"Administrator/admin_skpd/list_ttpNew/"+e+"/"+d);
                }
            });
        });
    });
...
<script>
    var urlUpdate = "<?php echo base_url('Administrator/admin_skpd/update'); ?>";
    $(document).ready(function() {
