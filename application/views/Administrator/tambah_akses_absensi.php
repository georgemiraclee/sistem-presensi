                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" id="add-form" action="javascript:void(0);" method="post">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div class="form-group form-float">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control" data-live-search="true" id="user_id" name="user_id" required>
                                                            <option></option>
                                                ...
                                                <div class="form-group form-float">
                                                    ...
                                                    <p style="font-size: 11px;" class="text-danger">* Silahkan tentukan lokasi yang akan diberikan kepada pegawai terpilih untuk melakukan absensi pada tanggal yang sudah ditentukan.</p>
                                                    ...
                                                    <p style="font-size: 11px; display: none;" id="text-range" class="text-danger">* Tentukan luas wilayah batas absensi dari lokasi yang sudah anda pilih.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="float-right">
                                  <button class="btn btn-secondary" type="button" onclick="window.location='<?php echo base_url();?>Administrator/akses_absensi'"><span class="fa fa-ban"></span> Batal</button>
...
<script>
    ...
    var coordinate = "";
    var radius = 1;
    var urlInsert = "<?php echo base_url('Administrator/akses_absensi/insert'); ?>";
    ...
    function placeMarker(location) {
        ...
        document.getElementById("text-range").style.display = "block";
    ...
    function setNull() {
        ...
        document.getElementById("range_01").style.display = "none";
        document.getElementById("text-range").style.display = "none";
    }
                        ...
                        try {
                            ...
                            if (result.status == true) {
                                swal(result.message, {
                                    ...
                                    window.location='<?php echo base_url();?>Administrator/akses_absensi';
                                });
                            } else {
