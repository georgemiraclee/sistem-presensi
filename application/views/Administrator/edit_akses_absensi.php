                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" id="add-form" action="javascript:void(0);" method="post">
                            ...
                            <div class="card-footer">
                                <div class="float-right">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-success" onclick="setNull()"><span>Reset</span></a>
                                    <button class="btn btn-default" type="button" onclick="window.location='<?php echo base_url();?>Administrator/akses_absensi'"><span class="fa fa-ban"></span> Batal</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    var urlInsert = "<?php echo base_url('Administrator/akses_absensi/update'); ?>";
