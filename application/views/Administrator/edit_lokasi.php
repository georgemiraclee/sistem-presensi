                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama_lokasi" id="nama_lokasi" class="form-control" placeholder="Nama Area" required value="<?php echo $data->nama_lokasi;?>">
                                                <input type="hidden" name="id_lokasi" id="id_lokasi" value="<?php echo $data->id_lokasi;?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
...
<script>
    var urlUpdate = "<?php echo base_url('Administrator/data_jaringan/updateLokasi'); ?>";
