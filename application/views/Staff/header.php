        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <nav class="mt-2">
                ...
                <!-- Add icons to the links using the .nav-icon class
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Staff/List_pegawai" class="nav-link">
                        <i class="nav-icon fa fa-users"></i>
                        <p>List Pegawai</p>
                        </a>
                    </li>
                    <!-- <li class="nav-item">
                        <a href="<?php echo base_url();?>Staff/Saldo" class="nav-link">
                        <i class="nav-icon fa fa-credit-card"></i>
                        <p>Potongan & Tunjangan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo base_url();?>Staff/simulasi" class="nav-link">
                        <i class="nav-icon fa fa-university"></i>
                        <p>Simulasi Pemotongan TPP</p>
                        </a>
                    </li> -->
                </ul>
            </nav>
