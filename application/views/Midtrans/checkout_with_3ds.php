...
<head>
	...
	<!-- Include PaymentAPI  -->
	<link rel="stylesheet" href="<?php echo base_url();?>asset/midtrans/css/jquery.fancybox.css">
</head>
<body>
	...
	<h1>Checkout</h1>
	<form action="<?php echo base_url()?>midtrans/vtdirect/vtdirect_cc_charge" method="POST" id="payment-form">
		<fieldset>
