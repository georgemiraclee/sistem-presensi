...
{ 
    ...
    public function index()
    {
        ...
        $getData = $query.' and c.is_admin = "0" order by j.created_absensi desc';
		...
		foreach ($datas as $key => $value) {
            ...
            if ($selectBatal) {
                ...
                $batal = '<a href="'.base_url().'SEKDA/data_absensi/batalkan/'.$value->id_absensi.' "><button class="btn bg-indigo btn-xs float-right" type="button">
                                Batalkan
                             </button></a>';
            }
			...
			<tr>
                        ...
                        <td>".$kembali."</td>
                        <td>".$pulang."</td>
                        <td>".$value->status_absensi." ". $keteranganTerlambat."</td>
