...
class akses_absensi extends CI_Controller
{
	...
	public function index()
	{
		...
		foreach ($akses_absensi as $key => $value) {
			...
			$data['list_akses_absensi'] .= "<tr>
                                                ...
                                                <td>
                                                    <a href='".base_url()."SO/akses_absensi/edit/".$value->id_akses_absensi."' style='color: grey'><span class='material-icons'>mode_edit</span></a>
		...
		$this->load->view('SO/akses_absensi');
	...
	public function add()
	{
		...
		$this->load->view('SO/header', $data);
		$this->load->view('SO/tambah_akses_absensi');
		$this->load->view('SO/footer');
	}
	...
	public function edit($id)
	{
		...
		$this->load->view('SO/header', $data);
		$this->load->view('SO/edit_akses_absensi');
		$this->load->view('SO/footer');
	}
