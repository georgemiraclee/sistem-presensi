...
{
	public function select_where($table, $where, $field = '*')
	{
	...
	public function select_all_where($table, $where, $field = '*')
	{
		$this->db->select($field);
		$this->db->from($table);
		$this->db->where($where);
	...
	public function query_all($sql, $dataBinding = [])
	{
		$query = $this->db->query($sql, $dataBinding);
		$result = $query->result();
